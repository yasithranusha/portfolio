...
const SCRIPT_RUN: TerminalLine[] = [
  ...
  { text: `        ${siteConfig.handle} [--lang=go|ts] [--env=k8s|aws] [--mode=cloud-native]`, color: "text-on-surface-variant" },
  { text: "" },
  ...
  { text: "        -D  Distributed_Systems", color: "text-on-surface-variant" },
  { text: "        -e  Event_Driven",        color: "text-on-surface-variant" },
  { text: "        -k  K8s_Native",          color: "text-on-surface-variant" },
  { text: "" },
...
const SCRIPT_CAT: TerminalLine[] = [
  ...
  { text: `echo "        ${siteConfig.handle} [--lang=go|ts] [--env=k8s|aws]"`, color: "text-on-surface-variant" },
  ...
  { text: 'echo "        -D  Distributed_Systems"',                              color: "text-on-surface-variant" },
  { text: 'echo "        -e  Event_Driven"',                                     color: "text-on-surface-variant" },
  { text: 'echo "        -k  K8s_Native"',                                       color: "text-on-surface-variant" },
...
const CURL_OUTPUT: TerminalLine[] = [
  ...
  { html: true, text: `  <span class="text-tertiary">"stack"</span>: [<span class="text-secondary-fixed-dim">"Go"</span>, <span class="text-secondary-fixed-dim">"TypeScript"</span>, <span class="text-secondary-fixed-dim">"Rust"</span>, <span class="text-secondary-fixed-dim">"K8s"</span>, <span class="text-secondary-fixed-dim">"AWS"</span>],` },
...
const CURL_SUDO_OUTPUT: TerminalLine[] = [
  ...
  { html: true, text: `    <span class="text-tertiary">"favorite_debugger"</span>: <span class="text-secondary-fixed-dim">"${siteConfig.sudo.root_secrets.favorite_debugger}"</span>` },
  { html: true, text: `  },` },
